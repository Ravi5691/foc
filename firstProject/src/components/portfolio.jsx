...
// const Portfolio = () => {
//   return (
//     <div className="h-screen w-[1330px] bg-elliptical-gradient mt-20 text-white p-10">
//     <div className="flex h-full">
//       {/* Left large section for images/reels/video */}
//       <div className="w-[600px] p-4">
//         <div className="h-full bg-white rounded-xl flex items-center justify-center text-black">
//           images/reels/vid
//         </div>
//       </div>

//       {/* Right section with portfolio text and smaller grid elements */}
//       <div className="w-[750px] h-[700px] p-4">
//         <div className="flex justify-center items-center mb-10 py-5 h-[25%]  ">
//           {/* Portfolio Title */}
//           <h1 className="text-9xl tracking-widest font-semibold">
...
//           {/* Info section */}
//           <div className="col-span-2 h-full bg-white p-4 rounded-xl flex items-center justify-center w-4/5 ">
//             Info/text/about us
//           </div>

//           {/* Numbers section */}
//           <div className='flex flex-col gap-3 w-[250px] justify-center'>
...
//           {/* Numbers section */}
//           <div className='flex justify-center w-[] gap-3 m-3 h-[150px]'>
