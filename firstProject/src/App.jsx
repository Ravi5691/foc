...
import LightCursor from './components/cursorEffect'; // Import the LightCursor component

function App() {
  return (
    <div className='min-h-screen flex flex-col place-items-center bg-elliptical-gradient scroll-smooth'>
      {/* Add the LightCursor component here */}
      <LightCursor />
      ...
      <div className='w-[1237px] h-[80px] -my-[30px] mx-[138px] text-center flex flex-col gap-0'>
        ...
        <br />
        <span className='text-base text-white'>Controlled Freelance environment which helps businesses get work done efficiently</span>
      </div>
